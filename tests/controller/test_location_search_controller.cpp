...
TEST_CASE("LocationSearchController Actions", "[controller][location_search]") {
    ...
    LocationController loc_controller(app_state, db_controller, []() {});
    LocationSearchController controller(loc_controller, trigger_redraw);
    ...
    SECTION("SelectSuggestion updates active coordinates via location_controller and resets modal state") {
